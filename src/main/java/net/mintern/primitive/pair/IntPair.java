...
/**
 * A pair modeled after {@link org.apache.commons.lang3.tuple.Pair} that consists of {@code int}
 * elements that allows users to avoid {@code Integer} boxing. It refers to the elements as 'left'
 * and 'right'.
 * <p>
 ...
 */
public abstract class IntPair implements PrimitivePair<Integer, Integer>, Comparable<IntPair> {

    private static final long serialVersionUID = 1;

    /**
     * Obtains an immutable pair of the given {@code int} values.
     *
    ...
    public static  IntPair of(int left, int right) {
        return ImmutableIntPair.of(left, right);
    }
    ...
    @Override
    public int hashCode() {
        return Integer.hashCode(getLeft()) ^ Integer.hashCode(getRight());
    }
