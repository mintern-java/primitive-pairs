...
/**
 * A mutable pair consisting of an {@code Object} element and an {@code int} element, providing a
 * version of {@link MutablePair} that avoids unnecessary {@code Integer} boxing.
 * <p>
 * Not #ThreadSafe#
 *
...
public class MutableObjIntPair<L> extends ObjIntPair<L> {
    ...
    /**
     * Obtains a mutable pair of the given {@code Object} and {@code int} values.
     *
     * @param <L> the left element type
     ...
     */
    public static <L> MutableObjIntPair<L> of(L left, int right) {
        return new MutableObjIntPair<>(left, right);
    }
     ...
     */
    public MutableObjIntPair(L left, int right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public MutablePair<L, Integer> boxed() {
