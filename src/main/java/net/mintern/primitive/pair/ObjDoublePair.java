 ...
 * {@code Object} and a {@code double} element that allows users to avoid {@code Double} boxing. It
...
public abstract class ObjDoublePair<L> implements PrimitivePair<L, Double>, Comparable<ObjDoublePair<L>> {
     ...
     */
    public static <L> ObjDoublePair<L> of(L left, double right) {
        return ImmutableObjDoublePair.of(left, right);
    }
     ...
     */
    @Override
    public int compareTo(ObjDoublePair<L> other) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ObjDoublePair<?>) {
            ObjDoublePair<?> o = (ObjDoublePair<?>) obj;
