 ...
 * {@code Object} and an {@code int} element that allows users to avoid {@code Integer} boxing. It
...
public abstract class ObjIntPair<L> implements PrimitivePair<L, Integer>, Comparable<ObjIntPair<L>> {
     ...
     */
    public static <L> ObjIntPair<L> of(L left, int right) {
        return ImmutableObjIntPair.of(left, right);
    }
     ...
     */
    @Override
    public int compareTo(ObjIntPair<L> other) {
