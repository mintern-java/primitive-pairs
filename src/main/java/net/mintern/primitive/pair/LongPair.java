...
/**
 * A pair modeled after {@link org.apache.commons.lang3.tuple.Pair} that consists of {@code long}
 * elements that allows users to avoid {@code Long} boxing. It refers to the elements as 'left'
 * and 'right'.
 * <p>
...
public abstract class LongPair implements PrimitivePair<Long, Long>, Comparable<LongPair> {
    ...
    public static  LongPair of(long left, long right) {
        return ImmutableLongPair.of(left, right);
    }
