...
/**
 * An immutable pair consisting of an {@code Object} and a {@code double} element, providing a version
 * of {@link org.apache.commons.lang3.tuple.ImmutablePair} that avoids unnecessary {@code Double}
 * boxing.
 * <p>
 ...
 */
public class ImmutableObjDoublePair<L> extends ObjDoublePair<L> {

    private static final long serialVersionUID = 1;

    /**
     * Obtains an immutable pair of the given {@code Object} and {@code double} values.
     *
     * @param <L> the left element type
     ...
     */
    public static <L> ImmutableObjDoublePair<L> of(L left, double right) {
        return new ImmutableObjDoublePair<>(left, right);
    }
     ...
     */
    public ImmutableObjDoublePair(L left, double right) {
        this.left = left;
        this.right = right;
    }
