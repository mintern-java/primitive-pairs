...
/**
 * An immutable pair consisting of {@code int} elements, providing a version of
 * {@link ImmutablePair} that avoids unnecessary {@code Integer} boxing.
 * <p>
 ...
 */
public final class ImmutableIntPair extends IntPair {
     ...
     */
    public static  ImmutableIntPair of(int left, int right) {
        return new ImmutableIntPair(left, right);
    }
