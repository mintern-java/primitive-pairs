...
/**
 * An immutable pair consisting of an {@code Object} and an {@code int} element, providing a version
 * of {@link org.apache.commons.lang3.tuple.ImmutablePair} that avoids unnecessary {@code Integer}
 * boxing.
 * <p>
 ...
 */
public class ImmutableObjIntPair<L> extends ObjIntPair<L> {

    private static final long serialVersionUID = 1;

    /**
     * Obtains an immutable pair of the given {@code Object} and {@code int} values.
     *
     * @param <L> the left element type
     ...
     */
    public static <L> ImmutableObjIntPair<L> of(L left, int right) {
        return new ImmutableObjIntPair<>(left, right);
    }
     ...
     */
    public ImmutableObjIntPair(L left, int right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public ImmutablePair<L, Integer> boxed() {
