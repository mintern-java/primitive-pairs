...
/**
 * An immutable pair consisting of a {@code double} element and an {@code int} element, providing a
 * version of {@link org.apache.commons.lang3.tuple.ImmutablePair} that avoids unnecessary
 * {@code Double} and {@code Integer} boxing.
 * <p>
 ...
 */
public class ImmutableDoubleIntPair extends DoubleIntPair {
     ...
     */
    public static ImmutableDoubleIntPair of(double left, int right) {
        return new ImmutableDoubleIntPair(left, right);
    }
     ...
     */
    public ImmutableDoubleIntPair(double left, int right) {
        this.left = left;
        this.right = right;
    }
